...
pub fn create_heightmap_terrain(
...
) -> (Terrain, (f32, RangeInclusive<f32>, RangeInclusive<f32>), Mesh) {
    ...
    (Terrain{collider: collider}, (max_height, (centre.x - size)..=(centre.x + size), (centre.z - size)..=(centre.z + size)), mesh)
}
...
pub fn create_heightmap_terrain(
    ...
    (Terrain{collider: collider}, (max_height, (centre.x - size)..=(centre.x + size), (centre.z - size)..=(centre.z + size)))
}
...
pub fn create_flat_terrain(
    ...
    (Terrain{collider: collider}, (centre.y, (centre.x - half_size)..=(centre.x + half_size), (centre.z - half_size)..=(centre.z + half_size)), mesh)
}
...
pub fn create_flat_terrain(
    ...
    (Terrain{collider: collider}, (centre.y, (centre.x - half_size)..=(centre.x + half_size), (centre.z - half_size)..=(centre.z + half_size)))
}