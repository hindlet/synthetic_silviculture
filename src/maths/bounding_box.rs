...
impl Collider for BoundingBox {
    ...
    fn check_ray(
        ...
        if self.contains_point(root_position) {return Some(RayHitInfo::new(root_position, Vector3::ZERO(), 0.0));}
        ...
        Some(RayHitInfo::new(root_position + direction * dist, out_norm, dist))
    }
}
