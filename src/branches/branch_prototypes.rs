...
pub struct BranchPrototypeData {
    ...
    layers: u32, // the number of layers in the tree diagram, used for interpolating growth
    node_counts: Vec<Vec<u32>>, // the number of nodes in each layer of the tree diagram: len() == layers - 1
    directions: Vec<Vector3>, // the directions of all the node pairs
    cuml_nodes: Vec<u32>,
}
